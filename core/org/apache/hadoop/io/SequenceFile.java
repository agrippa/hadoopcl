...
public class SequenceFile {
  ...
  public static final int SYNC_SIZE = 4+SYNC_HASH_SIZE; // escape + hash
  ...
  public static class Writer implements java.io.Closeable {
    ...
    public synchronized void writeChunk(byte[] buffer, int length) throws IOException {
