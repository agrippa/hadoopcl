...
class ReduceTask extends Task {
  ...
  private class NewTrackingRecordWriter<K,V> 
    ...
    @Override
    public void writeChunk(byte[] arr, int len) throws IOException, InterruptedException {
        throw new java.lang.UnsupportedOperationException("NewTrackingRecordWriter does not support writeChunk");
    }
  ...
  class ReduceCopier<K, V> implements MRConstants {
    ...
    private RawKeyValueIterator createKVIterator(
      ...
      System.out.println("INSIDE createKVIterator");
      // merge config params
      ...
      System.out.println("mapOutputsFilesInMemory.size() == "+mapOutputsFilesInMemory.size());
      ...
      System.out.println("onDiskBytes="+onDiskBytes);
      ...
      if (0 != onDiskBytes) {
        ...
        if (0 == finalSegments.size()) {
          System.out.println("Returning diskMerge");
          return diskMerge;
        }
