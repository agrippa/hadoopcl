...
public class DefaultTaskController extends TaskController {
  ...
  //private static final java.util.concurrent.ConcurrentLinkedQueue<Integer> freeDevices = new java.util.concurrent.ConcurrentLinkedQueue<Integer>(Arrays.asList(/* new Integer(2),*/ new Integer(1), new Integer(0)));
...
//          "bash", "-c", commandFile},
      ...
      LOG.info("Output from command "+cmdLine);
      LOG.info("Output from exception "+e.getMessage()+" "+e.toString());
