...
public abstract class IntDoubleIntDoubleHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void preKernelSetup(int[] setInputkeys, double[] setInputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals) {
    ...
    public IntDoubleIntDoubleHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntDoubleIntDoubleHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        while(ctx.nextKeyValue()) {
            ...
            this.javaProfile.startKernel();
            reduce(key.get(),             new HadoopCLDoubleValueIterator((double[])this.bufferedVals.getArray(), this.bufferedVals.size()));
            this.javaProfile.stopKernel();
