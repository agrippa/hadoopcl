...
public final class IntFloatHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    public  int[] inputKeys;
    public  float[] inputVals;
    private IntWritable currentKey;


    public IntFloatHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntFloatHadoopCLInputReducerBuffer other = (IntFloatHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
