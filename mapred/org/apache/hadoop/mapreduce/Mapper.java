...
public class Mapper<KEYIN, VALUEIN, KEYOUT, VALUEOUT> {
  ...
  public class Context 
    extends MapContext<KEYIN,VALUEIN,KEYOUT,VALUEOUT> {
        private final float[] outputVals;
        private final int[] outputKeys;
    ...
    public void writeWithID(KEYOUT key, VALUEOUT value, int id) throws IOException, InterruptedException {
        outputKeys[id] = ((IntWritable)key).get();
        outputVals[id] = ((FloatWritable)key).get();
    }
  }
