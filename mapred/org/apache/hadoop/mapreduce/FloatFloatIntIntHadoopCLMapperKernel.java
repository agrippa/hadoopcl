...
public abstract class FloatFloatIntIntHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    protected abstract void map(float key, float val);
    ...
    public void preKernelSetup(float[] setInputkeys, float[] setInputvals, int[] setNWrites, int setNPairs) {
    ...
    public FloatFloatIntIntHadoopCLMapperKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public FloatFloatIntIntHadoopCLMapperKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public Class<? extends HadoopCLInputBuffer> getInputBufferClass() { return FloatFloatHadoopCLInputMapperBuffer.class; }
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        FloatFloatHadoopCLInputMapperBuffer inputBuffer = (FloatFloatHadoopCLInputMapperBuffer)genericInputBuffer;
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        while(ctx.nextKeyValue()) {
            ...
            FloatWritable key = (FloatWritable)ctx.getCurrentKey();
