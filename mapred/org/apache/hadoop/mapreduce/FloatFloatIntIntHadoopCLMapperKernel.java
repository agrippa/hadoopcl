...
public abstract class FloatFloatIntIntHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(float[] setInputkeys, float[] setInputvals, int[] setOutputkeys, int[] setOutputvals, int[] setNWrites, int setNPairs, int[] setMemIncr, int setOutputsPerInput) {
