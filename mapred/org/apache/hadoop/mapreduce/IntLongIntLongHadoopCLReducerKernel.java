...
public abstract class IntLongIntLongHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    protected abstract void reduce(int key, HadoopCLLongValueIterator valIter);
    ...
    public void preKernelSetup(int[] setInputkeys, long[] setInputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals) {
    ...
    public IntLongIntLongHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntLongIntLongHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public Class<? extends HadoopCLInputBuffer> getInputBufferClass() { return IntLongHadoopCLInputReducerBuffer.class; }
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        IntLongHadoopCLInputReducerBuffer inputBuffer = (IntLongHadoopCLInputReducerBuffer)genericInputBuffer;
