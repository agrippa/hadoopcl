...
public abstract class IntLongIntLongHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void setup(int[] setInputkeys, long[] setInputvals, int[] setOutputkeys, long[] setOutputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals, int[] setMemIncr, int setOutputsPerInput) {
