...
public final class IntFsvecHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public IntFsvecHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
        ...
        inputValVals = new float[(this.clContext.getInputBufferSize()) * this.clContext.getInputValMultiplier() * this.clContext.getInputValEleMultiplier()];
    ...
    public final boolean isFull(TaskInputOutputContext context) throws IOException, InterruptedException {
        if (this.doingBulkRead) {
            ...
            return (this.nKeys == this.inputKeys.length ||
                this.nVals == this.inputValLookAsideBuffer.length ||
                this.individualInputValsCount + ((FSparseVectorWritable)reduceContext.getCurrentValue()).size() > this.inputValIndices.length);
        }
    }
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntFsvecHadoopCLInputReducerBuffer other = (IntFsvecHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
