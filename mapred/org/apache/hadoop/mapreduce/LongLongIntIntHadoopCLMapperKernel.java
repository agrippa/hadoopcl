...
public abstract class LongLongIntIntHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(long[] setInputkeys, long[] setInputvals, int[] setOutputkeys, int[] setOutputvals, int[] setNWrites, int setNPairs, int[] setMemIncr, int setOutputsPerInput) {
