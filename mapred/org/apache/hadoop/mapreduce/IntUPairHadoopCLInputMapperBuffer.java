...
public final class IntUPairHadoopCLInputMapperBuffer extends HadoopCLInputMapperBuffer {
    ...
    public IntUPairHadoopCLInputMapperBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public final int bulkFill(HadoopCLDataInput stream) throws IOException {
        ...
        while (stream.hasMore() &&
            ...
            this.inputValIds[this.nPairs] = tmpValId;
    ...
    public final void addTypedValue(Object val) {
        ...
        this.inputValIds[this.nPairs] = actual.getIVal();
