...
public class IntBsvecHadoopCLOutputReducerBuffer extends HadoopCLOutputReducerBuffer {
    ...
    public int putOutputsIntoHadoop(TaskInputOutputContext context, int soFar) throws IOException, InterruptedException {
        ...
        final BSparseVectorWritable saveVal = new BSparseVectorWritable();
        int count;
    ...
    public void initBeforeKernel(int outputsPerInput, HadoopOpenCLContext clContext) {
        ...
        if(outputsPerInput < 0) {
            outputKeys = null;
            outputValIntLookAsideBuffer = null;
            outputValDoubleLookAsideBuffer = null;
            outputValIndices = null;
            outputValVals = null;
