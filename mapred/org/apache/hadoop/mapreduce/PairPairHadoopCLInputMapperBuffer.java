...
public final class PairPairHadoopCLInputMapperBuffer extends HadoopCLInputMapperBuffer {
    ...
    public PairPairHadoopCLInputMapperBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
