...
public abstract class IntPairIntPairHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void setup(int[] setInputkeys, double[] setInputvals1, double[] setInputvals2, int[] setOutputkeys, double[] setOutputvals1, double[] setOutputvals2, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals, int[] setMemIncr, int setOutputsPerInput) {
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer, HadoopCLOutputBuffer genericOutputBuffer) {
        ...
        this.setup(inputBuffer.inputKeys, inputBuffer.inputVals1, inputBuffer.inputVals2, outputBuffer.outputKeys, outputBuffer.outputVals1, outputBuffer.outputVals2, inputBuffer.keyIndex, inputBuffer.nWrites, inputBuffer.nKeys, inputBuffer.nVals, outputBuffer.memIncr, this.outputsPerInput);
    }
