...
public abstract class IntIntIntPairHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(int[] setInputkeys, int[] setInputvals, int[] setOutputkeys, double[] setOutputvals1, double[] setOutputvals2, int[] setNWrites, int setNPairs, int[] setMemIncr, int setOutputsPerInput) {
