...
public abstract class LongLongIntLongHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(long[] setInputkeys, long[] setInputvals, int[] setOutputkeys, long[] setOutputvals, int[] setNWrites, int setNPairs, int[] setMemIncr, int setOutputsPerInput) {
