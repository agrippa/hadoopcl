...
public abstract class IntSvecIntDoubleHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(int[] setInputkeys, int[] setInputvalLookAsideBuffer, int[] setInputvalIndices, double[] setInputvalVals, int[] setOutputkeys, double[] setOutputvals, int[] setNWrites, int setNPairs, int setIndividualInputValsCount, int[] setMemIncr, int setOutputsPerInput) {
            ...
            while (lengthIter.hasNext()) {
                ...
                while (pairsIter.hasNext()) {
                    ...
                    for (int i = 0; i < curr.length; i++) {
                        ...
                        inputBuffer.inputValVals.unsafeSet(index + (i * inputBuffer.nPairs), curr.dvals[i]);
                    }
