...
public class JobContext {
  ...
  public static final String OCL_MAP_SCHEDULER = "mapreduce.map.ocl_scheduler";
  public static final String OCL_REDUCE_SCHEDULER = "mapreduce.reduce.ocl_scheduler";
  ...
  public String getMapOutputKeyClassString() {
      return conf.getMapOutputKeyClassString();
  }
  public String getMapOutputValueClassString() {
      return conf.getMapOutputValueClassString();
  }
  ...
  public Class getOCLMapperBufferClass() throws ClassNotFoundException {
    return conf.getClass(OCL_MAP_BUFFER_CLASS_ATTR);
  }

  public Class getOCLReducerBufferClass() throws ClassNotFoundException {
