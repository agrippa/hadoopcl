...
public class IntSvecHadoopCLInputMapperBuffer extends HadoopCLInputMapperBuffer {
    ...
    public boolean isFull(TaskInputOutputContext context) throws IOException, InterruptedException {
        SparseVectorWritable curr = (SparseVectorWritable)((Context)context).getCurrentValue();
        if (this.enableStriding) {
