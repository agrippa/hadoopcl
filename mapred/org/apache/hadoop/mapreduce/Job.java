...
public class Job extends JobContext {  
  ...
  public void setOCLCombinerClass(Class cls) throws IllegalStateException {
      ensureState(JobState.DEFINE);
      conf.setClass(OCL_COMBINE_CLASS_ATTR, cls);
  }

  public void setOCLMapperBufferClass(Class cls) throws IllegalStateException {
      ensureState(JobState.DEFINE);
      conf.setClass(OCL_MAP_BUFFER_CLASS_ATTR, cls);
  }

  public void setOCLReducerBufferClass(Class cls) throws IllegalStateException {
      ensureState(JobState.DEFINE);
      conf.setClass(OCL_REDUCE_BUFFER_CLASS_ATTR, cls);
  }
