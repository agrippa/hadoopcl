...
public class IntDoubleHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public void init(int outputsPerInput, HadoopOpenCLContext clContext) {
        ...
        inputVals = new double[this.clContext.getBufferSize() * inputValPerInputKey];
        this.initialized = true;
    }

    @Override
    public void bufferInputValue(Object obj) {
        DoubleWritable actual = (DoubleWritable)obj;
        ((HadoopCLResizableDoubleArray)this.tempBuffer1).add(actual.get());
    }
