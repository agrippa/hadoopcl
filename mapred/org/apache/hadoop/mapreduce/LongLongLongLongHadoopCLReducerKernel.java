...
public abstract class LongLongLongLongHadoopCLReducerKernel extends HadoopCLReducerKernel {
    public int outputLength;
    protected HadoopCLResizableLongArray bufferedVals = null;
    ...
    protected abstract void reduce(long key, HadoopCLLongValueIterator valIter);

    public void postKernelSetup(long[] setOutputkeys, long[] setOutputvals, int[] setMemIncr, int[] setNWrites, int[] outputIterMarkers) {
    ...
    public void preKernelSetup(long[] setInputkeys, long[] setInputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals) {
    ...
    public LongLongLongLongHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public LongLongLongLongHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public Class<? extends HadoopCLInputBuffer> getInputBufferClass() { return LongLongHadoopCLInputReducerBuffer.class; }
    public Class<? extends HadoopCLOutputBuffer> getOutputBufferClass() { return LongLongHadoopCLOutputReducerBuffer.class; }

    @Override
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        LongLongHadoopCLInputReducerBuffer inputBuffer = (LongLongHadoopCLInputReducerBuffer)genericInputBuffer;
    ...
    public void prepareForRead(HadoopCLOutputBuffer genericOutputBuffer) {
        LongLongHadoopCLOutputReducerBuffer outputBuffer = (LongLongHadoopCLOutputReducerBuffer)genericOutputBuffer;
    ...
    private final LongWritable keyObj = new LongWritable();
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        this.bufferedVals = new HadoopCLResizableLongArray();
        while(ctx.nextKeyValue()) {
            this.javaProfile.startRead();
            LongWritable key = (LongWritable)ctx.getCurrentKey();
            Iterable<LongWritable> values = (Iterable<LongWritable>)ctx.getValues();
            ...
            this.javaProfile.startKernel();
            reduce(key.get(),             new HadoopCLLongValueIterator((long[])this.bufferedVals.getArray(), this.bufferedVals.size()));
            this.javaProfile.stopKernel();
