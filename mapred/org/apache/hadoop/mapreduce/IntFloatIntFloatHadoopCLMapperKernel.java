...
public abstract class IntFloatIntFloatHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void setup(int[] setInputkeys, float[] setInputvals, int[] setOutputkeys, float[] setOutputvals, int[] setNWrites, int setNPairs, int[] setMemIncr, int setOutputsPerInput) {
