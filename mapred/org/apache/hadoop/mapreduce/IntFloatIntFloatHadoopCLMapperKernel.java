...
public abstract class IntFloatIntFloatHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    protected abstract void map(int key, float val);
    ...
    public void preKernelSetup(int[] setInputkeys, float[] setInputvals, int[] setNWrites, int setNPairs) {
    ...
    public IntFloatIntFloatHadoopCLMapperKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntFloatIntFloatHadoopCLMapperKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public Class<? extends HadoopCLInputBuffer> getInputBufferClass() { return IntFloatHadoopCLInputMapperBuffer.class; }
    public Class<? extends HadoopCLOutputBuffer> getOutputBufferClass() { return IntFloatHadoopCLOutputMapperBuffer.class; }

    @Override
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        IntFloatHadoopCLInputMapperBuffer inputBuffer = (IntFloatHadoopCLInputMapperBuffer)genericInputBuffer;
    ...
    public void prepareForRead(HadoopCLOutputBuffer genericOutputBuffer) {
        IntFloatHadoopCLOutputMapperBuffer outputBuffer = (IntFloatHadoopCLOutputMapperBuffer)genericOutputBuffer;
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        while(ctx.nextKeyValue()) {
            ...
            FloatWritable val = (FloatWritable)ctx.getCurrentValue();
