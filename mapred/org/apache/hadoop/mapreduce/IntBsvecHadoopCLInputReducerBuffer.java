...
public class IntBsvecHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public void init(int outputsPerInput, HadoopOpenCLContext clContext) {
        ...
        inputValVals = new double[(this.clContext.getBufferSize() * inputValPerInputKey) * 5];
    ...
    public void bufferInputValue(Object obj) {
        BSparseVectorWritable actual = (BSparseVectorWritable)obj;
