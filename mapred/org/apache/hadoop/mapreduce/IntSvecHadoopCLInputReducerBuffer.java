...
public final class IntSvecHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public IntSvecHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public final boolean isFull(TaskInputOutputContext context) throws IOException, InterruptedException {
        if (this.doingBulkRead) {
            ...
            return (this.nKeys == this.inputKeys.length ||
                this.nVals == this.inputValLookAsideBuffer.length ||
                this.individualInputValsCount + ((SparseVectorWritable)reduceContext.getCurrentValue()).size() > this.inputValIndices.length);
        }
    }
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntSvecHadoopCLInputReducerBuffer other = (IntSvecHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
