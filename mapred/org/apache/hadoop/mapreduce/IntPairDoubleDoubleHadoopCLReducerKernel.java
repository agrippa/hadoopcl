...
public abstract class IntPairDoubleDoubleHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void setup(int[] setInputkeys, double[] setInputvals1, double[] setInputvals2, double[] setOutputkeys, double[] setOutputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals, int[] setMemIncr, int setOutputsPerInput) {
