...
public abstract class IntIntIntIntHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void setup(int[] setInputkeys, int[] setInputvals, int[] setOutputkeys, int[] setOutputvals, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals, int[] setMemIncr, int setOutputsPerInput) {
