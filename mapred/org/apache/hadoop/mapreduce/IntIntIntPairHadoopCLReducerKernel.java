...
public abstract class IntIntIntPairHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void setup(int[] setInputkeys, int[] setInputvals, int[] setOutputkeys, double[] setOutputvals1, double[] setOutputvals2, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals, int[] setMemIncr, int setOutputsPerInput) {
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer, HadoopCLOutputBuffer genericOutputBuffer) {
        ...
        this.setup(inputBuffer.inputKeys, inputBuffer.inputVals, outputBuffer.outputKeys, outputBuffer.outputVals1, outputBuffer.outputVals2, inputBuffer.keyIndex, inputBuffer.nWrites, inputBuffer.nKeys, inputBuffer.nVals, outputBuffer.memIncr, this.outputsPerInput);
    }
