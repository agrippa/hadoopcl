...
public abstract class PairPairDoubleDoubleHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public void preKernelSetup(double[] setInputkeys1, double[] setInputkeys2, double[] setInputvals1, double[] setInputvals2, int[] setKeyIndex, int[] setNWrites, int setNKeys, int setNVals) {
    ...
    public PairPairDoubleDoubleHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public PairPairDoubleDoubleHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        ...
        this.preKernelSetup(inputBuffer.inputKeys1, inputBuffer.inputKeys2, inputBuffer.inputVals1, inputBuffer.inputVals2, inputBuffer.keyIndex, inputBuffer.nWrites, inputBuffer.nKeys, inputBuffer.nVals);
    }
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        while(ctx.nextKeyValue()) {
            ...
            this.javaProfile.startKernel();
            reduce(key.getVal1(), key.getVal2(),             new HadoopCLPairValueIterator(
