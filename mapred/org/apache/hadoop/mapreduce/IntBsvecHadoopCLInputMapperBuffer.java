...
public final class IntBsvecHadoopCLInputMapperBuffer extends HadoopCLInputMapperBuffer {
    ...
    public IntBsvecHadoopCLInputMapperBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
        ...
        if (this.doingBulkRead) {
            ...
            if (this.enableStriding) {
                ...
                return this.nPairs == this.capacity || this.individualInputValsCount +
                    ((BSparseVectorWritable)((Context)context).getCurrentValue()).size() > this.inputValIndices.length;
            }
        }
    }
