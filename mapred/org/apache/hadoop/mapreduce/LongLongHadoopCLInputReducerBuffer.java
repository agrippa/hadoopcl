...
public class LongLongHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public void init(int outputsPerInput, HadoopOpenCLContext clContext) {
        ...
        this.tempBuffer1 = new HadoopCLResizableLongArray();

        inputKeys = new long[this.clContext.getBufferSize()];
        inputVals = new long[this.clContext.getBufferSize() * inputValPerInputKey];
        this.initialized = true;
    }

    @Override
    public void bufferInputValue(Object obj) {
        LongWritable actual = (LongWritable)obj;
        ((HadoopCLResizableLongArray)this.tempBuffer1).add(actual.get());
    }
