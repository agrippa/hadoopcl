...
public final class LongLongHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    public  long[] inputKeys;
    public  long[] inputVals;
    private LongWritable currentKey;


    public LongLongHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
        ...
        while (stream.hasMore() &&
            ...
            if (this.currentKey == null || this.currentKey.get() != tmpKey) {
                ...
                if (this.currentKey == null) {
                    this.currentKey = new LongWritable(tmpKey);
                } else {
    ...
    public boolean sameAsLastKey(Object obj) {
        return ((LongWritable)obj).get() == this.inputKeys[this.nKeys-1];
    }
    @Override
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final LongLongHadoopCLInputReducerBuffer other = (LongLongHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
