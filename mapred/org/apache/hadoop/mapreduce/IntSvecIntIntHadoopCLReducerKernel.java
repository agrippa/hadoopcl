...
public abstract class IntSvecIntIntHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public IntSvecIntIntHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntSvecIntIntHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
