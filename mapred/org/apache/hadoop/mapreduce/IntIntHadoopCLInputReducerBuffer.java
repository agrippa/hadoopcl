...
public class IntIntHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public void init(int outputsPerInput, HadoopOpenCLContext clContext) {
        ...
        inputVals = new int[this.clContext.getBufferSize() * inputValPerInputKey];
        this.initialized = true;
    }

    @Override
    public void bufferInputValue(Object obj) {
        IntWritable actual = (IntWritable)obj;
        ((HadoopCLResizableIntArray)this.tempBuffer1).add(actual.get());
    }
