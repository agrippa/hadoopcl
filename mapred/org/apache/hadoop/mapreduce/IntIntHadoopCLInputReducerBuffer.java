...
public final class IntIntHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    public  int[] inputKeys;
    public  int[] inputVals;
    private IntWritable currentKey;


    public IntIntHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);

        inputKeys = new int[this.clContext.getInputBufferSize()];
        inputVals = new int[this.clContext.getInputBufferSize()];
    }
    ...
    public final int bulkFill(HadoopCLDataInput stream) throws IOException {
        ...
        while (stream.hasMore() &&
            ...
            stream.nextValue();
            final int tmpVal = stream.readInt();
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntIntHadoopCLInputReducerBuffer other = (IntIntHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
