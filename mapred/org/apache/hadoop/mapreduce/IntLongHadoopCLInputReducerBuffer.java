...
public final class IntLongHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    public  int[] inputKeys;
    public  long[] inputVals;
    private IntWritable currentKey;


    public IntLongHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntLongHadoopCLInputReducerBuffer other = (IntLongHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
