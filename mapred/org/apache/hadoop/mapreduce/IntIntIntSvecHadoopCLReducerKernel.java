...
public abstract class IntIntIntSvecHadoopCLReducerKernel extends HadoopCLReducerKernel {
    ...
    public IntIntIntSvecHadoopCLReducerKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntIntIntSvecHadoopCLReducerKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
