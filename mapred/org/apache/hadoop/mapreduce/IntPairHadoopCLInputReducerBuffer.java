...
public final class IntPairHadoopCLInputReducerBuffer extends HadoopCLInputReducerBuffer {
    ...
    public IntPairHadoopCLInputReducerBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public void transferLastKey(HadoopCLInputReducerBuffer otherBuffer) {
        final IntPairHadoopCLInputReducerBuffer other = (IntPairHadoopCLInputReducerBuffer)otherBuffer;
        this.nKeys = 1;
