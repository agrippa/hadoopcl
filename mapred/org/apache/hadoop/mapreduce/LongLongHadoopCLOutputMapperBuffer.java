...
public final class LongLongHadoopCLOutputMapperBuffer extends HadoopCLOutputMapperBuffer implements KVCollection<LongWritable, LongWritable> {
    ...
    public LongLongHadoopCLOutputMapperBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public static class KeyValueIterator extends HadoopCLKeyValueIterator {
        protected LongLongHadoopCLOutputMapperBuffer[] buffers;
        private final LongLongHadoopCLOutputMapperBuffer buf;

        public KeyValueIterator(Deque<OutputBufferSoFar> toWrite, final int numReduceTasks,
                final LongLongHadoopCLOutputMapperBuffer buf) {
            this.buf = buf;
            this.buffers = new LongLongHadoopCLOutputMapperBuffer[toWrite.size()];
            int count = 0;
            for (OutputBufferSoFar tmp : toWrite) {
                this.buffers[count++] = (LongLongHadoopCLOutputMapperBuffer)tmp.buffer();
            }
            this.sortedIndices = new TreeSet<IntegerPair>(new Comparator<IntegerPair>() {
                @Override
                public int compare(IntegerPair a, IntegerPair b) {
                    final LongLongHadoopCLOutputMapperBuffer aBuf = buffers[a.buffer];
                    final LongLongHadoopCLOutputMapperBuffer bBuf = buffers[b.buffer];
        ...
        public ByteBuffer getKeyFor(IntegerPair index) throws IOException {
            final LongLongHadoopCLOutputMapperBuffer buffer = buffers[index.buffer];
