...
public abstract class IntUPairIntPairHadoopCLMapperKernel extends HadoopCLMapperKernel {
    ...
    public void preKernelSetup(int[] setInputkeys, int[] setInputvalIds, double[] setInputvals1, double[] setInputvals2, int[] setNWrites, int setNPairs) {
    ...
    public IntUPairIntPairHadoopCLMapperKernel() {
        super(null, null);
        throw new UnsupportedOperationException();
    }
    public IntUPairIntPairHadoopCLMapperKernel(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
    ...
    public void fill(HadoopCLInputBuffer genericInputBuffer) {
        ...
        this.preKernelSetup(inputBuffer.inputKeys, inputBuffer.inputValIds, inputBuffer.inputVals1, inputBuffer.inputVals2, inputBuffer.nWrites, inputBuffer.nPairs);
    }
    ...
    public IHadoopCLAccumulatedProfile javaProcess(TaskInputOutputContext context) throws InterruptedException, IOException {
        ...
        while(ctx.nextKeyValue()) {
            ...
            this.javaProfile.startKernel();
            map(key.get(), val.getIVal(), val.getVal1(), val.getVal2()
);
            this.javaProfile.stopKernel();
