...
public final class IntFsvecHadoopCLInputMapperBuffer extends HadoopCLInputMapperBuffer {
    ...
    public IntFsvecHadoopCLInputMapperBuffer(HadoopOpenCLContext clContext, Integer id) {
        super(clContext, id);
        ...
        inputValVals = new float[(this.clContext.getInputBufferSize()) * this.clContext.getInputValEleMultiplier()];
        ...
        if (this.doingBulkRead) {
            ...
            if (this.enableStriding) {
                ...
                return this.nPairs == this.capacity || this.individualInputValsCount +
                    ((FSparseVectorWritable)((Context)context).getCurrentValue()).size() > this.inputValIndices.length;
            }
        }
    }
