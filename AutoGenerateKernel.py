...
def writeToHadoopMethod(fp, isMapper, hadoopOutputKeyType, hadoopOutputValueType, nativeOutputKeyType, nativeOutputValueType):
    ...
    if nativeOutputValueType == 'svec' or nativeOutputValueType == 'bsvec':
        ...
        fp.write('            final '+hadoopOutputValueType+'Writable saveVal = new '+hadoopOutputValueType+'Writable(this.outputValIndices, intStartOffset, outputValVals, doubleStartOffset, length);\n')
        ...
        fp.write('                final '+hadoopOutputValueType+'Writable saveVal = new '+hadoopOutputValueType+'Writable(this.outputVal, startOffset, length);\n')
        ...
        fp.write('                final '+hadoopOutputKeyType+'Writable saveKey = new '+hadoopOutputKeyType+'Writable();\n')
        writeln(visitor(nativeOutputKeyType).getKeyValSet('Key', 'i'), 4, fp)
        fp.write('                final '+hadoopOutputValueType+'Writable saveVal = new '+hadoopOutputValueType+'Writable(this.outputValIndices, intStartOffset, this.outputValVals, floatStartOffset, length);\n')
        ...
        firstLines = [ ]
        firstLines.append('                final '+hadoopOutputKeyType+'Writable saveKey = new '+hadoopOutputKeyType+'Writable();\n')
        firstLines.append('                final '+hadoopOutputValueType+'Writable saveVal = new '+hadoopOutputValueType+'Writable();\n')
        ...
        secondLines = [ ]
        secondLines.append('                final '+hadoopOutputKeyType+'Writable saveKey = new '+hadoopOutputKeyType+'Writable();\n')
        secondLines.append('                final '+hadoopOutputValueType+'Writable saveVal = new '+hadoopOutputValueType+'Writable();\n')
